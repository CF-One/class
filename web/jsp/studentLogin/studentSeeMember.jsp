...
<%
    ...
    String phone=teacherCourse.queryCourseTeacherPhone(courseId);
...
<div class="main">
    ...
    <div class="top">
        <!-- logo -->
        <div class="topLeft">
            <a href="/jsp/studentLogin/studentCourseDetail.jsp?courseId=<%=courseId%>" class="logo">
        ...
        <div class="topRight">
            ...
            <div class="touxiangBox">
                <a href="#">
                    <img src="/image/head/<%=studentCourseDao.selectStudentImg(studentPhone)%>.png" id="touxiang">
                </a>
                <!-- 点击弹出列表框 -->
                <div id="people">
                    <ul>
